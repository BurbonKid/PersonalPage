...
<head>
    ...
    <meta name="description" content="Darkster is a free, open source Bootstrap 4 theme" />
    ...
    <meta property="og:image" name="twitter:image" content="http://bootstrap.themes.guide/assets/ss_darkster.png">
    ...
    <meta name="twitter:description" content="Download Darkster - free, open source Bootstrap 4 theme by Themes.guide">
  ...
  <body data-spy="scroll" data-target="#navbar1" data-offset="60">
    <header class="bg-primary">
            ...
            <div class="row h-100">
                <div class="col-12">
                    <div class="text-center m-0 vh-100 d-flex flex-column justify-content-center text-light">
                        ...
                        <p class="lead">Hier gibt es einige Informationen über mich.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <a class="navbar-brand mr-1 mb-1 mt-0" href="index.php">Home</a>
